...
## Integrate your APIs with React

If you have gone thorugh [Quick Start with React](/react/guide/video-and-audio-calling-api-sdk/quick-start) you would have used sample token which authenticated your meetings, which is not an secure way and is not recommended for the production.
...
In order to integrate your APIs into the React app, create following methods and use them where ever required.
...
//Once you have the toke from the above method you can pass it here to generate new meeting
