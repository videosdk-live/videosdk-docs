...
# Toggle Participant Media - React
...
[How to apply permission while generating token?](/react/guide/video-and-audio-calling-api-sdk/server-setup#generate-accees-token-and-integrate-other-apis)
