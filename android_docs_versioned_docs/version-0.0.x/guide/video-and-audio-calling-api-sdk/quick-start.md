...
These quick start will help you integrate some of the basic functionalities that VideoSDK provides. You can check out the complete source code for this guide [here](https://github.com/videosdk-live/videosdk-rtc-ios-sdk-example). Once you are done with the tutorial given below your app should look like this.
