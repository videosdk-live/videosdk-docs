...
## Integrate your APIs with Android

If you have gone thorugh [Quick Start with Android](/android/guide/video-and-audio-calling-api-sdk/quick-start) you would have used sample token which authenticated your meetings, which is not an secure way and is not recommended for the production.
...
private void getToken() {
  AndroidNetworking.get(API_AUTH_URL + "/get-token")
    .build()
    .getAsJSONObject(new JSONObjectRequestListener() {
        @Override
        public void onResponse(JSONObject response) {  
          //You can use the token from here can call the createMeeting() to generate the meeting
...
private void createMeeting(String token) {
  AndroidNetworking.post(API_AUTH_URL + "/create-meeting")
    ...
    .getAsJSONObject(new JSONObjectRequestListener() {
        @Override
        public void onResponse(JSONObject response) {
          //Reponse will contain the meeting id
          //You can directly use it from here
        }
