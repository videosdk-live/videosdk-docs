...
While recording your meetings, you can choose to store them on the VideoSDK's storage or you can also configure your own **`AWS S3 Storage, Azure Blob or Google Cloud Storage`** to store the meeting recordings directly on your storage.

You can configure your own **`AWS S3 Storage, Azure Blob or Google Cloud Storage`** from the [VideoSDK Dashboard's API section](https://app.videosdk.live/api-keys).
