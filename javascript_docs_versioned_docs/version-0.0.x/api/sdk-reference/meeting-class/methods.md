...
- All [participants](../participant-class/introduction.md) and [localParticipant](../participant-class/introduction.md), will receive [`livestream-started`](./events.md#livestream-started) event.
...
- All [participants](../participant-class/introduction.md) and [localParticipant](../participant-class/introduction.md), will receive [`hls-started`](./events.md#hls-started) event.
...
- [`connection-close`](./events.md#connection-close) event of meeting class is triggered whenever `meeting.connectTo()` being called for both local and remote participants.
